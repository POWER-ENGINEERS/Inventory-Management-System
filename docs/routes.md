...
| GET | `/api/suppliers/{id}` | `SupplierController@showSupplier` | `GET /api/suppliers/10` | `{"status":"success","data":{...}}` |
...
| GET | `/api/stock-ins/{id}` | `StockInController@showStockIn` | `GET /api/stock-ins/1` | `{"status":"success","data":{...}}` |
| POST | `/api/stock-ins` | `StockInController@createStockIn` | `POST /api/stock-ins` | `{"status":"success","data":{...}}` |
| PUT | `/api/stock-ins/{id}` | `StockInController@updateStockIn` | `PUT /api/stock-ins/1` | `{"status":"success","data":{...}}` |
| DELETE | `/api/stock-ins/{id}` | `StockInController@deleteStockIn` | `DELETE /api/stock-ins/1` | `{"status":"success","message":"Stock-in deleted successfully"}` |
